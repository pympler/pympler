...
class FunctionTest(unittest.TestCase):
    ...
    def test_asized(self):
        ...
        if refs:  # XXX not sure what to test
    ...
    def test_asized_format(self):
        ...
        self.assertTrue(sized1_no.startswith("Foo\n    __class__\n    __dict__"))
        self.assertTrue(sized1_no.startswith(sized1_d1), (sized1_no, sized1_d1))
        self.assertTrue(sized1_no == sized1_d2, (sized1_no, sized1_d2))
        self.assertTrue(sized1_d1 == sized2_d1, (sized1_no, sized2_d1))
        self.assertTrue(sized2_d1 != sized2_d2, (sized1_no, sized2_d2))
    ...
    def test_asizesof_cyclic_references(self):
        ...
        self.assertTrue(cycle_size <= sum(sizes), (cycle_size, sum(sizes)))
#       self.assertEqual(cycle_size, sum(sizes))
    ...
    def test_asizer_limit(self):
        ...
        self.assertTrue(limit_sizes[2] <= limit_sizes[3], limit_sizes)  # XXX
    ...
    def test_basicsize(self):
        ...
        objects = [[], (), {}]
        for o in objects:
            self.assertEqual(asizeof.basicsize(o) - asizeof._sizeof.CPyGC_Head,
    ...
    def test_itemsize(self):
        ...
        itemsizes = [({}, asizeof._sizeof.CPyDictKeyEntry),
                     (set(), asizeof._sizeof.Csetentry),
                     ]
        for o, itemsize in itemsizes:
            z = asizeof.itemsize(o)
            self.assertTrue(z <= itemsize, (z, itemsize))
    ...
    def test_refs(self):
        ...
        self.assertTrue({'data': 42} in refs or (42,) in refs, refs)

        f = OldFoo(42)
        refs = list(asizeof.refs(f))
        self.assertTrue(len(refs) >= 1, len(refs))
        self.assertTrue({'odata': 42} in refs or (42,) in refs, refs)
